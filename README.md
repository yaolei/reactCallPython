# React + Python + Postgresql + antd
 
User could enter  some informations. Could check the stock & orders & user profile and so more.

An simple of the small CRM. The Front end use React & back end use the python
Data base with Postgresql and install with the docker
